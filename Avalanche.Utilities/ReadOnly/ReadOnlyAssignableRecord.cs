...
/// <summary>Base class for records that can be assigned as read-only, that do not copy @readonly field with 'with'.</summary>
public abstract record ReadOnlyAssignableRecord : IReadOnly
{
    ...
    /// <summary></summary>
    protected ReadOnlyAssignableRecord(ReadOnlyAssignableRecord other) { }

    /// <summary>Read-only assignable class with user-data container.</summary>
    public abstract record UserDataContainer : ReadOnlyAssignableRecord, IUserDataContainer
    {
        ...
        /// <summary>Read-only assignable class with user-data container.</summary>
        public abstract record LazyConstructed : UserDataContainer
        {
